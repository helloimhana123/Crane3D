...
export_1(Filename, Contents0, Attr) ->
    ...
    Contents1 = e3d_file:transform(Contents0, wpa:export_matrix(Attr)),
    Contents2 = wpa:save_images(Contents1, ImageDir, Imagetype),
    #e3d_file{objs=Objs, mat=Mat, creator=Creator} = Contents2,
